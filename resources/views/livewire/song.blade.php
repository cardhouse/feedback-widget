<div x-data="{ open: @entangle('active')}" x-show="open" class="p-3 bg-white hover:bg-gray-300 cursor-pointer">
    <div >
        <div class="flex items-middle justify-between align-middle">
            <h1 class="font-bold text-xl mb-3 w-1/2">
                {{ $track->title }}
            ...
            <button type="button" wire:click="trash({{ $track }})">
                <img src="https://www.svgrepo.com/show/2143/trash.svg" intrinsicsize="512 x 512" width="25" height="25" srcset="https://www.svgrepo.com/show/2143/trash.svg 4x" alt="Trash SVG Vector" title="Trash SVG Vector"></button>
        </div>
